"""
Generate dispersion datasets with the Python Bloch FEA library.

Creates metamaterial designs and computes dispersion relations, eigenvectors,
and system matrices for training / analysis.
"""
...
# Add the dispersion library next to this repo (works on any machine / clone).
dispersion_library_path = str(Path(__file__).resolve().parent / "2d-dispersion-py")
