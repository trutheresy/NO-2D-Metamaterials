...
def main() -> None:
    ...
    p.add_argument("--output-dir", default="", help="Output folder (default: <inference-dir>/boundary_length_vs_loss_by_band).")
    ...
    p.add_argument("--nmae-eps", type=float, default=1e-6)
    p.add_argument("--nmse-eps", type=float, default=1e-12)
    ...
    out_dir = Path(args.output_dir) if args.output_dir else infer_path.parent / "boundary_length_vs_loss_by_band"
