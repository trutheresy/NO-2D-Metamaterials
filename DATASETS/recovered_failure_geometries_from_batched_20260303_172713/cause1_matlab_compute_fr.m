...
outp = fullfile(repo_root, 'OUTPUT', 'recovered_failure_geometries_from_batched_20260303_172713', 'cause1_matlab_fr.mat');
S = load(inp);
designs = S.designs;
...
fprintf('Saved MATLAB frequency baseline to %s\n', outp);
