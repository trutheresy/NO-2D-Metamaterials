"""
Batch indexing and storage helpers for dispersion dataset generation.

Provides chunking (`make_chunks`) and array allocation (`init_storage`) used when
processing structures in batches.
"""
