...
N_struct = 1000; % Determines how many TOTAL designs will be generated, per parameter set.
N_struct_batch = 200; % Determines max number of designs that get saved per file
