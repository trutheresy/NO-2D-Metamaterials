...
const.isSaveKandM = false; % NEW: Flag for whether to save stiffness and mass matrices
...
N_struct = 3000; % Determines how many TOTAL designs will be generated, per parameter set.
N_struct_batch = 150; % Determines max number of designs that get saved per file
