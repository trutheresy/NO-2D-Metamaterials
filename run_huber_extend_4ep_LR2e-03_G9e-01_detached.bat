...
set LOG=%ROOT%\MODELS\training_runs\run_huber_extend_4ep_LR2e-03_G9e-01_detached.log

echo %date% %time% ^| === resume Huber 260626: +4 epochs (9-12), restore optimizer/scheduler LR pattern === >> "%LOG%"
