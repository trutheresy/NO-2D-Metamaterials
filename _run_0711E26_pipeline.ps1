# Full inference + analysis pipeline for NMAE+L1_0711 epoch-26 best checkpoint.
...
$ckpt = Join-Path $runDir "NO_I3O5_BCF16_NMAE_HC128_LR2e-03_WD0e+00_L1P1e-08_SS1_G9e-01_ch0u_260711_E26_best.pth"
if (-not (Test-Path -LiteralPath $ckpt)) {
    $ckpt = Join-Path $runDir "NO_I3O5_BCF16_NMAE_HC128_LR2e-03_WD0e+00_L1P1e-08_SS1_G9e-01_ch0u_260711_best.pth"
}
$MODEL = "NO_I3O5_BCF16_NMAE_HC128_LR2e-03_WD0e+00_L1P1e-08_SS1_G9e-01_ch0u_260711_E26_best"
...
Write-Output "=== 0711 E26 best pipeline ==="
...
Write-Output "`nALL_0711_PIPELINE_DONE $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')"
